...
// Gestion des plateformes : PC, Switch, PS5... toutes réunies sans guerre de fanboys
      ...
      {loading ? (
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <TouchableOpacity
              style={styles.item}
              onPress={() => navigation.navigate('detailPlateforme', { plateforme: item })}
            >
