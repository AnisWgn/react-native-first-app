...
// Détail d'un genre : RPG, FPS, etc. (spoiler : c'est surtout du texte)
export default function DetailGenre({ route, navigation }) {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>{genre.libelle ?? genre.nom ?? genre.id}</Text>
      <Text style={styles.text}>ID : {genre.id}</Text>
...
const styles = StyleSheet.create({
  container: { flex: 1, paddingTop: 50, paddingHorizontal: 12, alignItems: 'center', backgroundColor: '#E3F2FD', justifyContent: 'center' },
